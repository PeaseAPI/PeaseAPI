...
class OAuthController extends Controller
{
    ...
    public function bindEmail(Request $request)
    {
        ...
        return response()->json(['success' => true, 'message' => 'Email bound successfully']);
    }
    ...
    public function unbind(Request $request, string $providerId)
    {
        ...
        if ($binding) {
            ...
            $user = $request->user();
            if ($providerId === 'github') $user->github_id = '';
            if ($providerId === 'discord') $user->discord_id = '';
            if ($providerId === 'wechat') $user->wechat_id = '';
            if ($providerId === 'telegram') $user->telegram_id = '';
            if ($providerId === 'oidc') $user->oidc_id = '';
            if ($providerId === 'linuxdo') $user->linuxdo_id = '';
            $user->save();
        }
        
        return response()->json(['success' => true, 'message' => 'Unbound successfully']);
    }
    ...
    public function discovery(Request $request)
    {
        ...
        try {
            ...
            return response()->json(['success' => false, 'message' => 'Failed to fetch']);
        }
    }
    ...
    public function adminUnbind(Request $request, int $userId, string $providerId)
    {
        ...
        return response()->json(['success' => true, 'message' => 'Unbound']);
    }
