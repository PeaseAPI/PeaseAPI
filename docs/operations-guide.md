...
- **官方价目已核对预置**（迁移 `000003/000004/000005/000006/000007/000008` + 模板目录 `App\Services\CodingPlanCatalog`，2026-09-11 官方文档核对）：
  ...
  - 仍需人工补全：**腾讯旧逻辑模型逐档价**（deepseek-v4-*、glm-5/5.1/5.2、minimax-m2.7 官方仅给档位预估，模板取 Standard 口径兜底）；**百度积分制逐模型系数**（官方公告「即将支持」后补录）；**移动个人版视觉/视频模型豆率**（兑换口径为张/秒，AI 工具不可用，如有调用需求由管理员按需录入）。
